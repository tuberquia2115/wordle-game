...
const SwitchBody = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        width={78}
        height={38}
        viewBox='0 0 78 38'
...
const Switch = (props: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        <g filter='url(#a)'>
            <ellipse cx={18.55} cy={20} rx={13.65} ry={14.778} fill='url(#b)' />
            <ellipse cx={18.55} cy={20} rx={11.31} ry={12.244} fill='url(#c)' />
        </g>
        <defs>
            <linearGradient
                id='b'
            ...
            >
                ...
                <feBlend in2='BackgroundImageFix' result='effect1_dropShadow_115_1584' />
                <feBlend in='SourceGraphic' in2='effect1_dropShadow_115_1584' result='shape' />
            </filter>
        </defs>
    </svg>
);
...
export const SwitchDark = () => (
    <React.Fragment>
        <Switch className='absolute left-2' />
        <SwitchBody />
    </React.Fragment>
);
